...
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#1E2024', 'primaryTextColor': '#F0F1F2', 'primaryBorderColor': '#70A6C1', 'lineColor': '#70A6C1', 'textColor': '#F0F1F2', 'clusterBkg': '#121417', 'clusterBorder': '#70A6C1', 'edgeLabelBackground': '#70A6C1', 'tertiaryColor': '#1E2024', 'tertiaryTextColor': '#F0F1F2', 'tertiaryBorderColor': '#70A6C1'}, 'flowchart': {'subGraphTitleMargin': {'top': 0, 'bottom': 12}, 'rankSpacing': 70, 'nodeSpacing': 55, 'padding': 18}}}%%
flowchart TD
    ...
    classDef model fill:#315594,stroke:#70A6C1,stroke-width:1.5px,color:#F0F1F2;
    classDef score fill:#1E2024,stroke:#70A6C1,stroke-width:1.5px,color:#F0F1F2;
