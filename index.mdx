...
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#315594', 'primaryTextColor': '#F0F1F2', 'primaryBorderColor': '#315594', 'lineColor': '#70A6C1', 'textColor': '#F0F1F2', 'clusterBkg': 'transparent', 'clusterBorder': '#70A6C1', 'edgeLabelBackground': 'transparent', 'tertiaryColor': '#315594', 'tertiaryTextColor': '#F0F1F2', 'tertiaryBorderColor': '#315594'}, 'flowchart': {'subGraphTitleMargin': {'top': 0, 'bottom': 12}, 'rankSpacing': 70, 'nodeSpacing': 55, 'padding': 18}}}%%
flowchart TD
    ...
    classDef model fill:#70A6C1,stroke:#70A6C1,stroke-width:1.5px,color:#17181B;
    classDef score fill:#2F3675,stroke:#70A6C1,stroke-width:1.5px,color:#F0F1F2;
    classDef promoted fill:#70A6C1,stroke:#70A6C1,stroke-width:1.5px,color:#17181B;
    classDef none fill:#1E2024,stroke:#4A4D50,stroke-width:1.5px,color:#8A8E92;
```
