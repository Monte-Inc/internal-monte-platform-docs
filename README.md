...
See `AGENTS.md` for terminology (Measurement, Environment, Run, Cohort, Lineage, Recipe, Ledger) and content boundaries. Vocabulary is defined in `monte-nemo-platform/CONTEXT.md`.
