...
See `AGENTS.md` for terminology (Experiment, Environment, Run, Cohort, Lineage, Recipe, Ledger) and content boundaries. Vocabulary is defined in `monte-nemo-platform/CONTEXT.md`.
