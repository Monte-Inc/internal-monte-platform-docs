...
The groupings are not stored. A cohort and a lineage are both derived from row fields on request, so neither can fall out of agreement with the record it came from.
