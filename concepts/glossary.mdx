...
<Note>
  Before 2026-08-11, "Lineage" was Monte's word for what is now called a Cohort. It now means what it means elsewhere in ML, where a tuned model is itself a valid starting point.
</Note>
