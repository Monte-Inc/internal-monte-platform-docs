...
| **Vault** | The cloud bucket holding every frozen Environment and Dataset. It is the copy Monte treats as true. A data root holds a materialization of it, which `monte env install` fetches back and re-proves against the manifest. |
