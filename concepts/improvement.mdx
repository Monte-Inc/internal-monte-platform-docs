...
The figure below is a high-level view of that work with the [Improver](/concepts/core-loop) running it. Two things move at different speeds inside it: the model's weights, and the method used to change them.
...
flowchart LR
    ...
    subgraph OUTER["Moves the method"]
        direction TB
        EVAL["Eval on dev"]:::score --> LEDGER["Ledger"]:::entry --> AGENT["Improver"]:::model
    end
    CKPT --> EVAL
