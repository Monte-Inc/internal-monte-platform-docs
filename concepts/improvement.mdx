...
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#315594', 'primaryTextColor': '#F0F1F2', 'primaryBorderColor': '#315594', 'lineColor': '#70A6C1', 'textColor': '#17181B', 'titleColor': '#70A6C1', 'clusterBkg': 'transparent', 'clusterBorder': '#70A6C1', 'edgeLabelBackground': 'transparent', 'tertiaryColor': '#315594', 'tertiaryTextColor': '#F0F1F2', 'tertiaryBorderColor': '#315594', 'fontSize': '26px'}, 'flowchart': {'subGraphTitleMargin': {'top': 4, 'bottom': 16}, 'rankSpacing': 95, 'nodeSpacing': 30, 'padding': 28}}}%%
flowchart LR
    ...
    subgraph OUTER["Moves the method"]
        direction TB
        EVAL["Eval on dev"]:::score --> LEDGER["Ledger"]:::entry --> AGENT["Driving agent"]:::model
    end
    CKPT --> EVAL
    AGENT -->|"Select Checkpoint and Recipe"| RUN

    class INNER,OUTER cluster;
    classDef cluster fill:transparent,stroke:#70A6C1,stroke-width:1.5px,color:#70A6C1;
