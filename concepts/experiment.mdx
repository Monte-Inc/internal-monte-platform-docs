...
When the variables go unrecorded, old results become unreliable. Nothing explains why two numbers differ, so the experiments that produced them cannot be compared.
